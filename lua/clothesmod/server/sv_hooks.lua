...
hook.Add("PlayerSay", "ClothesMod:PlayerSay", function(ply, text)
    ...
    if text == "!cminv" or text == "!cinv" then -- Cats
        net.Start("ClothesMod:DropClothesMenu")
        net.Send(ply)
    end

    if text == "!wardrobe" or text == "!cmw" then -- Cats
        print("It's Here")
...
hook.Add("PlayerButtonDown", "ClothesMod:PlayerButtonDown", function(ply, button)
    ...
    if ply:CM_HasForbiddenJob() or not CLOTHESMOD.Config.CanOpenInventory then return end
