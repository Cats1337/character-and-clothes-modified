...
CLOTHESMOD.Config.Sentences[70][filename] = "CHEMISES" -- Cats
CLOTHESMOD.Config.Sentences[71][filename] = "PANTALONS" -- Cats
CLOTHESMOD.Config.Sentences[72][filename] = "TENUES" -- Cats
CLOTHESMOD.Config.Sentences[73][filename] = "SAUVEGARDEZ LA TENUE" -- Cats